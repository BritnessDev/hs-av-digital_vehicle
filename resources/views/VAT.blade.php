...
<head>
	...
	<title>Vollmacht Anwalt Trögl (1)</title>
	<style>
		body {
...
<body>
	...
	<div class="information">
		...
		<!-- Bernhard Trögl -->
		<h4>{{ $streen_no }}</h4>
		<!-- Marktplatz 5, D-91785 Pleinfeld -->
		<h4>{{ $zipcode }} {{ $city }}</h4>
	...
	<div class="signature" style="margin-top: 10px;">
		<div class="left w-fit">
			<div class="w-fit" style="margin-right: 20px; width: 150px; height: 50px; font-weight: bolder; font-size: 20px;"> {{$input3}} </div>
			<hr />
			<span>Ort, Datum</span>
		</div>
